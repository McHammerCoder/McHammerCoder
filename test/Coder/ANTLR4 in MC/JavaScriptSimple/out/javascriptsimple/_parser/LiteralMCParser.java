 ...
 */
public class LiteralMCParser extends MCConcreteParser {
   ...
   */
  public Optional<javascriptsimple._ast.ASTLiteral> parse(String filename) throws IOException, RecognitionException {   
    ...
    javascriptsimple._ast.ASTLiteral ast = parse(parser);
    if (parser.hasErrors()) {
      hasErrors = true;
      return Optional.<javascriptsimple._ast.ASTLiteral> empty();
    }
   ...
   * @throws RecognitionException
   * */
  public  Optional<javascriptsimple._ast.ASTLiteral> parse(Reader reader) throws IOException, RecognitionException {
   ...
   *
   */
  public  Optional<javascriptsimple._ast.ASTLiteral> parseString(String parseString) throws IOException, RecognitionException {
   ...
   * 
   */
  protected javascriptsimple._ast.ASTLiteral parse(JavaScriptSimpleParser parser) throws RecognitionException {
    
    javascriptsimple._ast.ASTLiteral ret;
    
    if (this.getParserTarget().equals(ParserExecution.NORMAL)){
      ret =  parser.literal().ret;
    }
    else {
      ret= parser.literal_eof().ret;
    }
