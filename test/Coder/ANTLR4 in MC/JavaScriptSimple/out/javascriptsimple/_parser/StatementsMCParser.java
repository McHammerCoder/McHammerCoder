 ...
 */
public class StatementsMCParser extends MCConcreteParser {
   ...
   */
  public Optional<javascriptsimple._ast.ASTStatements> parse(String filename) throws IOException, RecognitionException {   
    ...
    javascriptsimple._ast.ASTStatements ast = parse(parser);
    if (parser.hasErrors()) {
      hasErrors = true;
      return Optional.<javascriptsimple._ast.ASTStatements> empty();
    }
   ...
   * @throws RecognitionException
   * */
  public  Optional<javascriptsimple._ast.ASTStatements> parse(Reader reader) throws IOException, RecognitionException {
   ...
   *
   */
  public  Optional<javascriptsimple._ast.ASTStatements> parseString(String parseString) throws IOException, RecognitionException {
   ...
   * 
   */
  protected javascriptsimple._ast.ASTStatements parse(JavaScriptSimpleParser parser) throws RecognitionException {
    
    javascriptsimple._ast.ASTStatements ret;
    
    if (this.getParserTarget().equals(ParserExecution.NORMAL)){
      ret =  parser.statements().ret;
    }
    else {
      ret= parser.statements_eof().ret;
    }
