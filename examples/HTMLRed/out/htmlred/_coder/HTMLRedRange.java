...
/* generated by template coder.Range*/
...
public class HTMLRedRange {
		private char LowerBound;
		private char UpperBound;
		private boolean isNegative;
		
	public HTMLRedRange(char L, char U, boolean neg){
		LowerBound = L;
		UpperBound = U;
		isNegative = neg;		
	}
	...
	public boolean isNegative(){
		...
		public String[] union(HTMLRedRange range){
	...
	public static String[] union(ArrayList<HTMLRedRange> ranges){
		
		Set<String> set = new HashSet<>();
		for(HTMLRedRange range : ranges){
			if(!range.isNegative()){
